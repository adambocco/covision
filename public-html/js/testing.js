...
function sendFacilityAJAX(currentPage,searchString) {
    ...
    if (searchString != null && searchString != "") {
        ...
        xhr.open("GET", "http://" + window.location.hostname + "/testing/listings?page="+currentPage+"&search="+querySearchString);
    } else {
        xhr.open("GET", "http://" + window.location.hostname + "/testing/listings?page="+currentPage);
    }
    xhr.send();
}
